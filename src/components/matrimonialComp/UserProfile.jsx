    ...
    <div className="min-h-screen bg-gray-100 flex justify-center items-center p-4 lg:p-10">
      <div className="bg-white rounded-2xl shadow-lg w-full max-w-6xl lg:flex lg:space-x-12 p-8 lg:p-12">
        ...
        <div className="lg:w-1/3 flex flex-col items-center lg:items-start">
          ...
          {/* Name & Title */}
          <h1 className="text-3xl lg:text-4xl font-bold text-gray-800 mb-2">Ravi Sharma</h1>
          <p className="text-lg text-gray-500 mb-4">Software Developer at Infosys</p>
        ...
        <div className="lg:w-2/3 mt-10 lg:mt-0">
          ...
          {/* About Family */}
          <div className="mb-10">
            <h2 className="text-2xl font-semibold text-gray-700 mb-4">About Family</h2>
            <p className="text-gray-600 leading-relaxed">
              We are a simple and down-to-earth family. My father works for the government, and my mother is a homemaker. 
              We value traditions and believe in maintaining a good balance between modern and cultural values.
            </p>
          </div>

          {/* Express Yourself */}
          <div className="mb-10">
            <h2 className="text-2xl font-semibold text-gray-700 mb-4">Express Yourself</h2>
            <p className="text-gray-600 leading-relaxed">
              I am passionate about software development and enjoy working on new and challenging projects. I like to keep myself 
              updated with the latest technology trends. In my free time, I enjoy traveling, reading, and cooking.
            </p>
          </div>

          {/* Edit Button */}
          <div className="flex justify-center lg:justify-start">
            <button className="px-8 py-3 bg-blue-600 text-white font-semibold rounded-lg shadow-lg hover:bg-blue-500 hover:scale-105 transition-all">
              Edit Profile
            </button>
          </div>
        </div>
