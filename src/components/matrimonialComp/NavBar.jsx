...
console.log(profileFor)
            ...
            setProfileFor('son')
            setEmailAddress('demo@perfios.com')
            ...
            <button
                ...
                <header className="bg-slate-700 shadow fixed top-0 left-0 right-0 z-50 mx-64 ">
                    <div className="flex justify-between items-center  h-16   mx-auto ">
                        <div className="bg-white text-center h-16 w-32 flex items-center justify-center">
                                <span className="text-xl font-bold text-pink-600 text-center">Soul Match</span>
                            </div>
                                        ...
                                        <ul className="py-2">
                                            <li>
                                                <Link href="/profiledetails">
                                                    <div className="block px-4 py-2 hover:bg-gray-100">Soul Match</div>
                                                </Link>
                                            </li>
                                            <li>
                                                <Link href="/help">
                                            ...
                                            <li>
                                                <div className="block px-4 py-2 hover:bg-gray-100 cursor-pointer">Soul Match</div>
                                            </li>
                                        </ul>
                                    </div>
                                )}
                ...
                <div className="text-center py-6 flex justify-between  mt-10 px-64 ">
                    <div className='flex flex-col items-start justify-end text-white '>
                        ...
                        <span className="text-lg ">Finding your perfect match just became easier</span>
                    </div>
                    <div >
                    {showLoginForm ? <LoginForm /> : <RegisterForm profileFor1 ={profileFor} emailAddress={emailAddress} mobileNum={mobileNum} password1={password}/>}
                    </div>
                </div>

                <div className="bg-gray-100 rounded-r-xl rounded-l-xl   px-16 mx-64">
                

                        <div className='pt-6'>
                            <div className="">
                                <span className="text-base text-gray-700 ">MORE THAN 20 YEARS OF</span>
                            </div>
                        ...
                        <div className="flex justify-center space-x-12">
                            <div className="    ">
                                ...
                                <h6 className="text-base font-semibold mb-2">100% Manually Screened Profiles</h6>
                            ...
                            <div className="">
                                ...
                                <h6 className="text-base font-semibold mb-2">Verification by Personal Visit</h6>
                                <div className="w-16 h-1 bg-pink-500  mb-1"></div>
                                <div className="text-gray-700">
                            ...
                            <div className="">
                                ...
                                <h6 className="text-base font-semibold mb-2">Control over Privacy</h6>
                                <div className="w-16 h-1 bg-pink-500  mb-1"></div>
                                <div className="text-gray-700">
