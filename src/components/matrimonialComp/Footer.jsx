...
import { FaAndroid, FaApple, FaFacebook, FaTwitter, FaInstagram } from 'react-icons/fa';
            ...
            <div id="js-footer">
                        ...
                        <div className="w-full flex   gap-56  pt-5 text-gray-400">
                            ...
                            <div className="w-full">
                                <ul className="text-sm space-y-2">
                                    ...
                                    <li><a href="#" className="hover:text-white">Soul Match Careers</a></li>
                                </ul>
                            </div>
                            ...
                            <div className="w-full">
                                <ul className="text-sm space-y-2">
                                    ...
                                    <li><a href="#" className="hover:text-white">Soul Match centers (32)</a></li>
                                </ul>
                            </div>
                            ...
                            <div className="w-full">
                                <ul className="text-sm space-y-2">
                                    ...
                                    <li><a href="#" className="hover:text-white">3rd party terms of use</a></li>
                ...
                <div className="pt-5 pb-6 bg-[#2E4154] text-white">
                    ...
                    <div>
                        ...
                        <a href="#" target="_blank" className="inline-block mr-2">
