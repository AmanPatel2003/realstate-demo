...
const IntroPage = () => {
  ...
  return (
    ...
    >
      <div className="w-[40%] flex pt-20  pl-16">
        <div>
      ...
      <div className="w-[60%] p-4  flex gap-4">
        <RegisterForm
        ...
        <button
          ...
          className="bg-white h-14 w-24 text-[#071C55] border border-[#071C55] focus:ring-2 hover:bg-[#071C55] hover:text-white font-medium rounded-md text-sm    py-1 text-center"
        >
          Fill data
        </button>
      </div>
