  ...
  const stories = [
    {
      id: 1,
      image:
        "https://imagecdn.jeevansathi.com/53344/12/1066892719-1725030144.jpg",

      name: "Nitin Bhagwani ~ Payal Sachdeva",
      description:
        "Firstly I want to thank this platform (JS), as I had found my partner via your platform. I have been searching since 2020 but I was disheartened, but suddenly at...",
      link: "#",
    },
    {
      id: 2,
      image:
        "https://i.pinimg.com/736x/ac/84/b1/ac84b110731961f3e64d59190413dce0.jpg",
    ...
    },
    {
      id: 3,
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQx1P4dhuPQ8RSYjc4Ef5U23T9PRxBtFh5BLA&s",
      name: "Lova Raju ~ Gantyada Saraswati",
      description:
        "This is a great app to find the perfect match. Thanks to Jeevansathi.com",
      link: "#",
    },
    {
      id: 4,
      image:
        "https://imagecdn.jeevansathi.com/53319/8/1066388881-1724909924.jpg",
      name: "Porus Bhagwat ~ Rutuja Gumas",
      description:
        "I found my suitable match here. I am happy and thankful to Jeevansathi.com",
      link: "#",
    },
    {
      id: 5,
      image:
        "https://imagecdn.jeevansathi.com/53319/5/1066385021-1724909204.jpg",
      name: "Shubham Pathak ~ Richa Sharma",
      description:
        "We found a perfect match for our sister as per our expectations. I would like to thank Jeevansathi.com. Marriage is done in July. Both are living happily and...",
      link: "#",
    },
    {
      id: 6,
      image:
        "https://i.pinimg.com/564x/9b/cb/1f/9bcb1f30e6e2974faa8d59847979abd1.jpg",
      name: "Naruto ~ Hinata",
    ...
    <>
      <div className="bg-gray-100 min-h-screen ">
        ...
        <header
          ...
          style={{
            backgroundImage: `url('https://images.squarespace-cdn.com/content/v1/5a8341d74c0dbfe48dba9903/1550884275730-NMXOP1CNZ5K3GWKK6N2C/tips-young-married-couples.jpeg')`,
          }}
        >
        ...
        <div className="flex justify-center mt-8  relative ">
          ...
          <div className="flex space-x-4 overflow-x-auto">
            {Array.from({ length: 9 }, (_, i) => 2024 - i).map((year) => (
              <button
                key={year}
                className="px-4 py-2 bg-white text-gray-600 hover:bg-gray-200"
              >
                {year}
              </button>
            ))}
      ...
      <footer className="bg-gray-800 text-gray-200 py-8">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mt-8 border-t border-gray-700 pt-6 text-center text-sm text-gray-400">
            ...
            <p className="mt-4">
              © 2016 Jeevansathi Internet Services. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
