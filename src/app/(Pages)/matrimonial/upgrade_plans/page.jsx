      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {plans.map((plan) => (
            <div
              key={plan.id}
              className={`p-6 border-2 rounded-lg shadow-md cursor-pointer transition duration-300 ${
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    ...
                    {method.id === 4 &&
                      "Pay using your UPI ID for fast transactions."}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-8 bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  className={`w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-600 placeholder-gray-400 ${
